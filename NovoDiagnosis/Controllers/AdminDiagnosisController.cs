    ...
    public class AdminDiagnosisController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, string Email, string AppointmentDate, string AuthorizationCode, string Provider, [Bind("Id,FullName,StaffId,Provider,State,Email,PhoneNumber,AppointmentDate,AppointmentTime,CompletedAnnualMedical,Approve,Reject,CreatedOn,UpdatedOn,AuthorizationCode,Recommendation,UserName,Status,History,PresentingComplain,Diagnosis,PlanTest")] DiagnosisDetails diagnosisDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //    message.From.Add(new MailboxAddress("E-mail From Name", "novohealthafrica@outlook.com"));
                //    //E-mail subject 
                //    message.Subject = "Appointment Approved";
                //    //E-mail message body
                //    message.Body = new TextPart(TextFormat.Html)
                //    {
                //        Text = "<p>Dear esteemed client,</p><br/><p> Your annual medical checkup have been scheduled for " + AppointmentDate + " at " + Provider + ". </p><p>Your Authorization Code is " + AuthorizationCode + ". Kindly go to the Hospital with this code.</p><br><br/><p>Thank you for choosing Novo Health Africa</p>"
                //    };
                ...
                //        emailClient.Authenticate("novohealthafrica@outlook.com", "Novo123*");
